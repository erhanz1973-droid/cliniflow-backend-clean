...
const CLINIFLY_PLATFORM_FREE_FACT = {
  ...
  ka: "Clinifly-ის პაციენტისა და ექიმის/კლინიკის აპლიკაცია სრულიად უფასოა — ჩამოტვირთვა, რეგისტრაცია და კლინიკის კოდით გაწევრიანება ფასიანი არ არის.",
};
...
function buildSmileAnalysisMessengerConversionReply(lang = "en", options = {}) {
  ...
  if (key === "ka") {
    return sanitizePartnerClinicLanguageLeak(
