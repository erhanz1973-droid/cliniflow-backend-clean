...
function parseCoordinatorPayload(content) {
  ...
  if (raw && typeof raw === "object") {
    ...
    const conversationalIntake = normalizeConversationalIntake(
      raw.conversationalIntake ?? raw.conversational_intake,
    );
    if (reply) {
      return { reply, leadData, conversationSummary, conversationalIntake };
    }
  }
  ...
  return {
    ...
    conversationSummary: "",
    conversationalIntake: normalizeConversationalIntake(null),
  };
}
