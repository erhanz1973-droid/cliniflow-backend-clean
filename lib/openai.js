...
* share numeric prices ONLY when the patient asks for a specific amount (e.g. «fiyat ne kadar», «kaç lira», «how much») — NOT for «pahalı mı» / «is it expensive»
* for «pahalı mı»: 2–3 sentences, qualitative only (varies by case) — no TL/EUR figures; they can ask «kaç lira» if they want numbers
