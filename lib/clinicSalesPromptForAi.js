...
async function buildClinicSalesPromptForAi(clinicId, params) {
  ...
  if (intent.isCommercialQuestion) {
    lines.push(
      "RESPONSE ORDER: (1) Answer the commercial question directly using data below. (2) Brief coordinator tone. (3) Optional next step (booking). (4) Imaging/documents only if clinically relevant for this treatment tier — not as a substitute for pricing.",
    );
  }
