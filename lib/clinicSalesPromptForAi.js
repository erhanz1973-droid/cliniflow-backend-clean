...
function buildNoPricingGuardPrompt(params, materials, intent, relevant) {
  const lines = [
    ...
    intent.asksCostSensitivity && !intent.asksDirectPrice
      ? "* Answer in 2–3 short sentences WITHOUT any TL/EUR/$ numbers or ranges — say cost varies by brand, bone, and scope."
      : "* Do NOT volunteer prices, cost ranges, currency amounts, or phrases like \"fiyatımız\", \"starting from\", or \"approximately €X\".",
    intent.asksCostSensitivity && !intent.asksDirectPrice
      ? "* You may say it depends on the case; invite them to ask «fiyat ne kadar» / «kaç lira» if they want a numeric estimate."
