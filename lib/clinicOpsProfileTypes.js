...
const OPS_PROFILE_SECTIONS = [
  ...
  },
  {
    ...
    subtitle:
      "Soft conversion behavior — tone, CTA style, pricing approach, forbidden phrases (default: Soft Conversion Coordinator).",
    storage: "settings.knowledgeBase.conversionEngine",
  },
  {
    id: "materials",
...
function buildDefaultConversionEngineConfig() {
  const { buildDefaultConversionConfig } = require("./conversionEngine");
  return buildDefaultConversionConfig();
}

module.exports = {
  OPS_PROFILE_SCHEMA_VERSION,
  buildDefaultConversionEngineConfig,
  AUTONOMY_LEVELS,
  AUTONOMY_CATEGORIES,
