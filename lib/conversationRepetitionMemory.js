...
const SOCIAL_ACK_RE =
  /^(teşekkür|teşekkürler|teşekür|sağol|sağ\s*ol|thanks|thank\s*you|thank\s*u|iyi\s+akşamlar|iyi\s+geceler|günaydın|good\s+(evening|morning|night)|hello|hi|hey|merhaba|selam)[\s!.?,🙏]*$/iu;
