...
function buildDocumentIntakePromptBlock(flags, documents, patientMessage = "") {
  ...
  } else if (f.missingXray && commercial.isCommercialQuestion) {
    lines.push(
      "* Patient asked a pricing/commercial question — answer using clinic pricing data first; mention imaging only if needed for surgical planning after giving ranges.",
    );
  }
