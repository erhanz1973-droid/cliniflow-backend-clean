...
function timelineLabel(eventType, meta = {}, lang = "en") {
  ...
  switch (eventType) {
    ...
    case "human_takeover":
      if (m.conversationOwner === "doctor") {
        return actor
          ? t(L, "timeline.doctor_took_over", { actor })
          : t(L, "timeline.doctor_took_overGeneric");
      }
      return actor
    ...
    case "ai_resumed":
      if (m.conversationOwner === "ai") {
        return actor
          ? t(L, "timeline.ai_resumed_conversation", { actor })
          : t(L, "timeline.ai_resumed_conversationGeneric");
      }
