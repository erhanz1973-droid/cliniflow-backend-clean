...
function buildConversationLanguagePromptBlock(state) {
  ...
  const lines = [
    ...
    state.phoneOnly
      ? null
      : `* If the patient wrote in Turkish, reply in Turkish. If Arabic, reply in Arabic. If Russian, reply in Russian. Never default to English or Turkish unless the patient message is clearly in that language.`,
