...
const TUTORIAL_YOUTUBE_URL = "https://www.youtube.com/@Clinifly";
...
function getBundledCliniflyOnboardingKb() {
  return [
    ...
    {
      id: "onboard.tutorial_videos",
      screenKey: "tutorial_videos",
      topicId: "tutorials",
      priority: 88,
      locales: ["en", "tr", "ka", "ru"],
      questions: [
        ...
        "youtube",
        "clinifly videos",
        "nasıl kullanılır video",
        "nasil kullanilir video",
        "kullanım videosu",
        "kullanim videosu",
        "egitim video",
        "eğitim video",
      ...
      userExplanation:
        "Clinifly has official step-by-step tutorial videos on YouTube covering registration, settings, AI training, and channel setup.",
      steps: [
        `Open the Clinifly YouTube channel: ${TUTORIAL_YOUTUBE_URL}`,
        "Browse videos for clinic registration, admin login, AI Training Center, treatment prices, Directory Profile, WhatsApp/Messenger connection, and Lead inbox.",
        "Watch the section that matches your question — each video walks through the admin UI step by step.",
      ],
      commonMistakes: [
        "Assuming there are no tutorial videos — the YouTube channel is the primary how-to library.",
        "Skipping videos and trying random admin screens without watching the matching walkthrough first.",
      ],
      faq: [
        {
          q: "Where are Clinifly tutorial videos?",
          a: `On our YouTube channel: ${TUTORIAL_YOUTUBE_URL}`,
        },
        {
          q: "What topics do the videos cover?",
          a: "Clinic registration, login, Settings, AI Training, treatment prices, Directory Profile, doctor approval, Lead inbox, and WhatsApp/Messenger setup.",
        },
      ],
      aiSupportAnswers: [
        `Yes — Clinifly has official how-to videos on YouTube: ${TUTORIAL_YOUTUBE_URL}. Never say we have no videos.`,
        "For setup help, start with the YouTube channel; each video follows the admin UI in order.",
      ],
      tags: ["onboarding", "tutorial", "youtube", "videos"],
    },
  ];
}

module.exports = { getBundledCliniflyOnboardingKb, REGISTER_URL, LOGIN_URL, TUTORIAL_YOUTUBE_URL };
