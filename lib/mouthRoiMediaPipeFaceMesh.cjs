...
// Polyfill before any `require('@tensorflow/tfjs')` so Node/Railway never throws ReferenceError.
const os = require('os');
const _navPoly = {
  userAgent: 'Node.js',
...
// Node.js native TensorFlow binding — load before any `require('@tensorflow/tfjs')`.
