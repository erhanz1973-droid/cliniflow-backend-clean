...
const SECTION_HELP = {
  ...
  "conversion-coordinator": {
    ...
    intro:
      "Soft conversion behavior — tone, CTA style, pricing approach, and forbidden phrases. Trust-first governance, not a sales bot.",
    aiUsageSummary: "Conversion Engine strategy block in coordinator replies; optional timeline analytics.",
  },
};
...
const FIELD_HELP = [
  ...
  {
    id: "protocol.aiNotes",
    label: "Notes for your AI assistant",
    visibility: "internal",
    helper: "Staff-only reminders for this treatment — priorities, phrases to use or avoid with patients.",
    aiUsage: "Helps the AI stay aligned with how your team usually explains this treatment.",
