...
const SECTION_HELP = {
  "ai-profile": {
    ...
    intro: "How your clinic assistant introduces itself and speaks. This shapes every AI message tone — not medical content.",
    aiUsageSummary: "Injected into AI coordinator prompts as voice and language settings.",
  },
  "treatments-pricing": {
    title: "Treatments & Pricing",
    intro: "Structured price ranges and visit info. AI uses ranges to answer cost questions — never as a guaranteed final quote.",
    aiUsageSummary: "Offer generation, pricing Q&A, treatment comparison replies.",
  },
  materials: {
...
const FIELD_HELP = [
  ...
  },
  {
    ...
    visibility: "patient_visible",
    helper: "Languages the AI should offer to write in.",
    aiUsage: "Language detection and reply language selection.",
    placeholder: "en, tr, ar, ru",
    example: "English, Turkish, Arabic",
  },
  {
    id: "signatureStyle",
...
function listFieldsForSection(sectionId) {
  ...
  if (!prefix) {
    const sectionFieldIds = {
      "ai-profile": ["displayName", "toneStyle", "supportedLanguages", "signatureStyle", "profileTags"],
      materials: [
        "implantBrands",
        "premiumBrands",
        "zirconiumTypes",
  ...
  return FIELD_HELP.filter((f) => f.id.startsWith(prefix));
}
