...
function isSalesAcknowledgmentMessage(message) {
  ...
  if (detectVisitorTypeFromMessage(m)) return false;
...
NEVER repeat Stage 1 or Stage 2 mid-conversation. Once you have explained a product topic (WhatsApp AI, pricing, registration, etc.), short acknowledgments like "mantıklı", "bence de", "ok", "makes sense" mean continue the SAME topic — do NOT greet again and do NOT re-ask clinic vs patient.
