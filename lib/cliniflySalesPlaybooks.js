...
function buildPatientAcquisitionValueFirstReply(lang) {
  ...
  return (
    "Here's how Clinifly helps clinics acquire more patients — outcome first:\n\n" +
    "• International patients can discover your clinic through Clinifly and contact you directly.\n" +
    "• Patients can send photos and treatment inquiries so you qualify leads faster.\n" +
    "• AI answers WhatsApp, Messenger, and Clinifly messages 24/7 in many languages.\n" +
    "• You choose whether AI replies automatically or your staff handles conversations.\n" +
    "• The referral system helps existing patients invite new patients.\n" +
    "• We support international patient communication and health-tourism workflows.\n" +
    "• Marketing and patient-acquisition activities can bring new opportunities to partner clinics.\n\n" +
    "When you're ready to try this with your clinic, say \"how do I register\" — free self-service signup, no credit card required."
  );
}
